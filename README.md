...
2. [Setup - The basics of getting started with alpha](#setup)
    * [What alpha affects](#what-alpha-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with alpha](#beginning-with-alpha)
